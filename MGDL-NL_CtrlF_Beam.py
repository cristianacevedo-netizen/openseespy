...
recorder('Element', '-file', "Outputs/Forces/Ele1BasicForce.out",'-ele', 1,"basicForce")


recorder('Element', '-file', "Outputs/Forces/Ele1BasicDef.out",'-ele', 1,"basicDeformation")
recorder('Element', '-file', "Outputs/Forces/Ele1PlasticDef.out",'-ele', 1, "plasticDeformation")

recorder('Element', '-file', "Outputs/Forces/inflectionPoint.out",'-ele', 1, "inflectionPoint")
recorder('Element', '-file', "Outputs/Forces/tangentDrift.out",'-ele', 1, "tangentDrift")
recorder('Element', '-file', "Outputs/Forces/integrationPoints.out",'-ele', 1, "integrationPoints")
recorder('Element', '-file', "Outputs/Forces/integrationWeights.out",'-ele', 1, "integrationWeights")

recorder('Element', '-file', "Outputs/Forces/Ele1ForceGP.out",'-ele', 1, "section",1,"force")
recorder('Element', '-file', "Outputs/Forces/Ele1DefGP.out",'-ele', 1, "section",1,"deformation")
...
Wy=0.0
Wz=40.0
eleLoad('-ele', 1,2,3,4,'-type', '-beamUniform', Wy, Wz)
