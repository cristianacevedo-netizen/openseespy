...
dof=1
eigenvector=3
ux1=nodeEigenvector(NodeEnd+1, eigenvector, dof)
ux2=nodeEigenvector(NodeEnd+2, eigenvector, dof)
print('ux1:',ux1)
print('ux2:',ux2)
wipeAnalysis()
...
# GRAVITY ANALYSUS
# OUTPUTS
ruta_pvd = "Outputs/PVDgravity"
os.makedirs(ruta_pvd, exist_ok=True)
recorder("PVD", ruta_pvd, "disp")

# create a plain load pattern
pattern("Plain", 1, tagTS)
load( 3, 0, 0, -9810, 0, 0, 0)
load( 5, 0, 0, -9810, 0, 0, 0)
load( 8, 0, 0, -9810, 0, 0, 0)
load(10, 0, 0, -9810, 0, 0, 0)
load(12, 0, 0, -9810, 0, 0, 0)

load(16, 0, 0, -9810, 0, 0, 0)
load(18, 0, 0, -9810, 0, 0, 0)
load(21, 0, 0, -9810, 0, 0, 0)
load(23, 0, 0, -9810, 0, 0, 0)
load(25, 0, 0, -9810, 0, 0, 0)

load(29, 0, 0, -9810, 0, 0, 0)
load(31, 0, 0, -9810, 0, 0, 0)
load(34, 0, 0, -9810, 0, 0, 0)
load(36, 0, 0, -9810, 0, 0, 0)
load(38, 0, 0, -9810, 0, 0, 0)

load(42, 0, 0, -9810, 0, 0, 0)
load(44, 0, 0, -9810, 0, 0, 0)
load(47, 0, 0, -9810, 0, 0, 0)
load(49, 0, 0, -9810, 0, 0, 0)
load(51, 0, 0, -9810, 0, 0, 0)
...
# PUSHOVER ANALYSUS
# create a plain load pattern
pattern("Plain", 2, tagTS)
load(NodeEnd+1, ux1, 0, 0, 0, 0, 0)
load(NodeEnd+2, ux2, 0, 0, 0, 0, 0)
...
Fstep13=np.zeros(Nsteps)
Fstep17=np.zeros(Nsteps)
...
for i in range(Nsteps):
    ...
    Fstep=eleForce(1)
    eleR=eleResponse(1, "section",1,"force")
    
    # ustep[i]=nodeDisp(5, 1)
    ustep[i]=nodeDisp(NodeEnd+2, 1)
    ...
    Fstep13[i]=eleForce(13, 1)
    Fstep17[i]=eleForce(17, 1)
    nstep[i]=i+1

Fstep=Fstep1+Fstep5+Fstep13+Fstep17
print('PUSHOVER ANALYSIS')
plt.plot(ustep,-Fstep*1e-3)
plt.title('F-u')
plt.show()
