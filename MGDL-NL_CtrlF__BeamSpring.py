...
matTag3=3
E=8000
uniaxialMaterial('Elastic', matTag3, E)
...
NodeEndCoord=nodeCoord(NodeEnd)
node(NodeEnd+1,*NodeEndCoord) 
fix(NodeEnd+1, 1,1,1,1,1,1)      
    
equalDOF(NodeEnd+1,NodeEnd,1,2)


Elems=getEleTags()
ElemEnd=Elems[-1]
element('zeroLength', ElemEnd+1, NodeEnd,NodeEnd+1, '-mat', matTag3, '-dir', 3)
